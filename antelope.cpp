...
Antelope::Antelope(int xCoord, int yCoord) {
	symbol = 'A';
	strength = 4;
	initiative = 4;
	x = xCoord;
...
void Antelope::action(vector<Entity*>& entities, World* world, Logger &log, int width, int height) {
...
int Antelope::collision(Entity* attacker) {
	if (attacker != this) {
...
void Antelope::makeChild(vector<Entity*>& entities, int x, int y) {
